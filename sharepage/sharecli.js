...
var genCmd = {
    ...
    */
    ...
    templs : [
        ...
        { file: "back_route.js" , out : "routes/{module_name}ctl.js" },
        { file: "front_module.js" , out : "public/js/{module_name}.js" },
        { file: "front_module.html" , out : "views/{module_name}/{module_name}page.html" },
    ],
    ...
    exec : function(args){
        ...
        //拆解模块名称  moduleName = module_name,module_desc
        var moduleDesc = moduleName;
        if(moduleName.indexOf(',') >=0 ){
            var v = moduleName.split(',');
            moduleName = v[0];
            moduleDesc = v[1];
        }
        ...
        var templs = genCmd[moduleType + '_templs'] || genCmd.templs;
        templs.forEach(function(templ){
            var tempfile = moduleType + "/" + templ.file,
                outfile = outdir + "/" + templ.out.replace
