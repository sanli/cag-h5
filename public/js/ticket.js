//#!本文件由share.js自动产生于Tue Apr 14 2015 17:52:44 GMT+0800 (CST), 产生命令行为: node share.js gen ticket CRUD ..
...
var Module = $.extend(new $M(), {
        ...
        Module.listPage(type, cond, sortarg, page
            , function(module){
                ...
                $M.fillResult($resultTarget, {
                    ...
                    bodyId: ticket + 'cellTbody',
                    tempId : ticket + 'CellTable',
                    sort: sort,
                });
    ...
    updateModule: function(_id, options){
        ...
        updateModule = function(condition, fn, fail){
            $M.doupdate('/ticket/u', condition, { successfn : fn , failfn: fail});
        },
        // 查询楼宇详细信息
        loadDataDetail = function(_id, fn){
            $M.doquery('/ticket/retrive', {_id : _id}
                , { successfn : fn ,
                    alertPosition : '#buildingNavtab'});
        };
