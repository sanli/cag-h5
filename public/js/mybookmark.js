...
var Module = $.extend(new $M(), {
    ...
    bind : function(){
        ...
        // 删除数据
        $('#cellDiv').on('click', 'button.action-remove', function(e){
            var _id = $(e.target).closest('div.painting').data('uuid');
